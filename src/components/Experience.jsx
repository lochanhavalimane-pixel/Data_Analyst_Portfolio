      ...
      <ScrollReveal className="mx-auto max-w-[110rem] px-5 sm:px-8 lg:px-12">
        <RevealItem className="grid gap-10 lg:grid-cols-[0.32fr_0.68fr] lg:gap-14">
          ...
          <RevealItem className="lg:sticky lg:top-24 lg:self-start">
            ...
            <p className="hidden mt-4 text-sm text-muted leading-relaxed md:block">
          ...
          <ScrollReveal className="space-y-4 md:space-y-8">
            {profileData.certifications.map((item, idx) => (
              <RevealItem key={idx} as="article" className="rule-t pt-4 first:border-t-0 first:pt-0 md:pt-6">
                <div className="md:hidden">
                  <div className="flex items-start justify-between gap-3">
                    <button
                      type="button"
                      aria-expanded={expandedCertification === idx}
                      aria-controls={`certification-details-${idx}`}
